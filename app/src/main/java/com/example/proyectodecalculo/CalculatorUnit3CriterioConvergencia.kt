...
class CalculatorUnit3CriterioConvergencia : AppCompatActivity() {
    private lateinit var etsumTo: EditText
    private lateinit var etsumComp: EditText
    private lateinit var tvAnswer: TextView
    private lateinit var mvIMG: ImageView

    override fun onCreate(savedInstanceState: Bundle?) {1
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_calculator_unit3_criterio_convergencia)

        mvIMG = findViewById(R.id.mvIMG)

        etsumTo = findViewById(R.id.etSumTo)
        etsumComp = findViewById(R.id.etSumComp)
        ...
        submitProblem.setOnClickListener {
            ...
            val to = etsumTo.text.toString().trim { it <= ' '}
            val comp = etsumComp.text.toString().trim { it <= ' '}
    ...
    private fun sendProblemToWolfram(to: String, comp: String) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val prob = "The sum of [//math:$comp//] from [//math:$to//] to [//math:Infinity//]"
            ...
            client.newCall(request).execute().use { response ->
                ...
                if (responseBody != null) {
                    ...
                    launch(Dispatchers.Main) {
                        ...
                        if (imageUrl != null) {
                            Glide.with(this@CalculatorUnit3CriterioConvergencia)
                                .load(imageUrl)
                                .into(mvIMG)
                        }
                    }
